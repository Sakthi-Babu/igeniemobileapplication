  ...
  return (
    <View style={styles.maindiv}>
      ...
      <View style={styles.info}>
        ...
        <Image source={require('./Images/caterpillar.png')} style={styles.logoimage}/> 
      </View>
...
const styles = StyleSheet.create({
  maindiv: {
    ...
    height: 159, // Adjusted height to accommodate images and padding
    borderRadius: 8,
    backgroundColor: "#FFF",
    shadowColor: "#000",
    shadowOffset: {
